...
def parse_args():
    parser = argparse.ArgumentParser(description="DoRA")
    parser.add_argument("--train_args_file", type=str, default="dora.json")
    #parser.add_argument("--model_name_or_path", type=str, default="/home/llama/llama-2-7b")
    parser.add_argument("--model_name_or_path", type=str, default="/home/llama/llama-2-7b")
    
    parser.add_argument("--data_path", type=str, required=True)
    parser.add_argument("--test_path", type=str,
                        default="/home/SiameseModelTrain/chatglm/dataset/ropes/data_test.json")
    parser.add_argument("--output_path", type=str,
                        default="/home/SiameseModelTrain/qwen/baseline/adalora/dataset_out/ropes2_test.json")
    parser.add_argument("--evaluation_datapath", type=str,
                        default="/home/SiameseModelTrain/qwen/evaluation_result/adalora_ropes2.log")
...
class ModifiedTrainer(Trainer):
    def compute_loss(self, model, inputs, return_outputs=False):
        return model(input_ids=inputs["input_ids"],attention_mask=inputs["attention_mask"],labels=inputs["labels"]).loss
